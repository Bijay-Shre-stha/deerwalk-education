...
<div class="container-fluid diploma-bg">
    <div class="container page-title">
        <h4 class="display-6 text-center r-d-unit-top">DWIT Power Workshop Courses</h4>
    </div>
</div>

<?php 
    $powerWorkshops = $obj->getAllDataByField('power_workshop', array('id', 'code', 'subject','description'), NULL, array('id' => 'ASC'));
?>

<!--Main content-->
<div class="container-fluid">
        <div class="col-md-12" id="detailss">
        <h3 class='semester-header text-center'>DWIT Power Workshop Courses</h3>
        <div class='accordion' id='accordionExample'>
            <?php $count=0; ?>
            <?php foreach($powerWorkshops as $course): ?>
                <?php $count++; ?>
                <div class="card">
