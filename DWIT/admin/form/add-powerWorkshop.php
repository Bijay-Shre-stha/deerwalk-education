...
if (isset($_GET['hid'])) {
    $id = (int)$_GET['hid'];
    $oldData = $obj->getFieldDataById("power_workshop", array("id", "code", "subject", "description"), $id);
    $action = "edit";
} else {
    $action = "add";
}
...
<h2 class="text-center">Add DWIT Power Workshop</h2>

<form action="?fold=actpages&page=act_powerWorkshop" id="add-powerWorkshop" method="POST">
