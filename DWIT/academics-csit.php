<?php
$pgName = 'Academics - Bsc. CSIT';
include('./include/header.php') ?>

<!--Page Banner-->
<div class="container-fluid CSIT-bg">
    <div class="container page-title">
        <h4 class="display-6 text-center r-d-unit-top">ACADEMICS - BSC. CSIT</h4>
    </div>
</div>
